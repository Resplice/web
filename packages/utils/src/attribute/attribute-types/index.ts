...
import dateTimeType from '$utils/attribute/attribute-types/date-time'
...
import { AttributeType, type AttributeTypeConfig } from '$utils/attribute/attribute.types'
...
export const attributeTypes: Record<AttributeType, AttributeTypeConfig> = {
	...
	[AttributeType.DATE_TIME]: dateTimeType,
