<script lang="ts">
	import type { CredentialValue } from '$modules/attribute/attribute.types'
	import IconButton from '@resplice/components/package/IconButton.svelte'
	import EyeIcon from '@resplice/components/package/icons/EyeIcon.svelte'
	import EyeOffIcon from '@resplice/components/package/icons/EyeOffIcon.svelte'
